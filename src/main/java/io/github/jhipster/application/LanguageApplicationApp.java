...
public class LanguageApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(LanguageApplicationApp.class);

    private final Environment env;

    public LanguageApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes languageApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(LanguageApplicationApp.class);
